...
import com.rahmanda.moneyflow.data.TransactionManager // <--- INI ADALAH BARIS IMPORT KRITIS
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Inisialisasi TransactionManager saat aplikasi dimulai
        ...
        // Auto-fill for testing purposes (optional)
        // username.setText("alvin")
